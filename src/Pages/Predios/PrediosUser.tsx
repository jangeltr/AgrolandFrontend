...
import { getHasEstado, getHasEstadoPorCultivo, getHasMunicipio, getHasMunicipioPorCultivo, getPrediosPorCultivo, getPrediosSinCultivo } from '../../Common/Predios';
...
export default function PrediosUser(): JSX.Element {
