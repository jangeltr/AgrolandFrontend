...
const navigation = [
    { name: 'Registrarse', href: '/createUser', current: true },
                ...
                <>
                    ...
                    <Disclosure.Panel className="sm:hidden">
                        <div className="space-y-1 px-2 pb-3 pt-2">
                            {navigation.map((item) => (
                                <Disclosure.Button key={item.name} as="a" href={item.href} className='text-gray-300 p-2 hover:bg-gray-700 rounded-md block'>
                                    {item.name}
                                </Disclosure.Button>
                            ))}
                        </div>
